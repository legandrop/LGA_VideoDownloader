...
// AppPaths::heavyDataDir("session-cookies") (Windows `<app>/session-cookies`, macOS Application
// Support), que se borra cuando el proceso termina (ok, error, cancel o
...
// Carpeta de los temporales (ver AppPaths::heavyDataDir).
QString directory();
